...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_LOWER] = LAYOUT( /* [> LOWER <] */
    ...
    KC_TRNS, KC_LBRC, KC_LPRN, KC_TRNS, KC_COMM,        KC_DOT,  KC_TRNS, KC_QUOT, KC_DQT,  KC_TRNS,
    KC_TRNS, KC_RBRC, KC_RPRN, KC_TRNS, KC_TRNS,        KC_BSLS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,
